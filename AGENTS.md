...
- 现状基线：622 项测试全绿、208 次提交、11 份 ADR、双站线上（CF Pages + GH Pages，缓存 v52）、IndexedDB 主快照 + localStorage 副本（双写双存，集合级逐 key）、可选 AES-GCM 加密（逐集合 bundle）、PWA、Web Worker、12 个 hash 路由模块。
