...
- 现状基线：692 项测试全绿、231 次提交、12 份 ADR（新增 ADR-013 写路径统一收口）、双站线上（CF Pages + GH Pages，缓存 v69）、IndexedDB 主快照 + localStorage 副本（双写双存，集合级逐 key）、可选 AES-GCM 加密（逐集合 bundle）、PWA、Web Worker、12 个 hash 路由模块。
