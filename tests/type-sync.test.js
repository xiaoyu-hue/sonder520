...
function extractStoreMethods() {
  const files = ['store.js', 'store-tasks.js', 'store-media.js', 'store-content.js', 'store-settings.js', 'store-report.js', 'store-undo.js', 'store-persistence.js', 'store-migration.js', 'store-import-export.js'];
