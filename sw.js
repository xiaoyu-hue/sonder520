...
var ASSETS = [
  ...
  './js/store-migration.js',
  './js/store-import-export.js',
  './js/store-tasks.js',
  './js/repositories/task-repository.js',
  './js/domain/task-domain.js',
  './js/store-media.js',
  './js/repositories/dev-repository.js',
  './js/store-content.js',
  './js/repositories/book-repository.js',
  './js/repositories/clients-repository.js',
  './js/repositories/games-repository.js',
  './js/store-settings.js',
  './js/repositories/settings-repository.js',
  './js/repositories/memo-repository.js',
  './js/repositories/news-repository.js',
  './js/repositories/design-repository.js',
  './js/ui.js',
  './js/motion.js',
  './js/error-guard.js',
  './js/search.js',
